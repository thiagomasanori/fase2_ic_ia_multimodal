...
A primeira tarefa consistiu em criar e configurar um PACs (Picture Archiving and Communication System) usando o Orthanc no Docker.
  ...
  A imagem utilizada foi "jodogne/orthanc-python" pois o interpretador do Python 3.7 já estava embarcado no pacote.
...
A terceira tarefa exigia a aplicação de um modelo de classificação nos arquivos DICOM da tarefa anterior, porém não foi concluída. A ideia era usar a biblioteca [github.com/mlmed/torchxrayvision](https://github.com/mlmed/torchxrayvision/tree/master) , com modelos pré-treinados presentes no repositório.
